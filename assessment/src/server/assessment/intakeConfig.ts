  ...
  // Challenge 1 — About You
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'multiselect',
        label: 'What are your hobbies or personal interests? (Select all that apply)',
        description: 'We use this to recommend projects that actually interest you.',
        required: false,
        options: [
          ...
          { value: 'social_impact', label: 'Social impact & nonprofits' },
      ...
      },
      {
        id: 'ai_motivation',
        type: 'text',
        label: 'Why do you want to learn AI-powered software development?',
        description: 'Tell us in your own words — there are no wrong answers.',
        required: false,
        placeholder: 'e.g. I want to build AI tools that help people learn faster...',
      },
    ],
  } as QuestionnaireStepConfig,
